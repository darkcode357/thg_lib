...
import ssl
import time
from THG_libs.thg_auxiliares.thg_cores.conf_colors import *
...
class DOS:
    ...
    def run(HOST, PORT, SOCKETS, VERBOSE, RANDUSERAGENTS, USEPROXY, PROXY_HOST, PROXY_PORT, HTTPS):
        ...
        for _ in range(int(SOCKETS)):
            try:
                socketfd = DOS.init_socket(HOST, PORT, SOCKETS, VERBOSE, RANDUSERAGENTS, USEPROXY, PROXY_HOST, PROXY_PORT, HTTPS)
